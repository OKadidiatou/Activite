...
<head>
    ...
    <title>Modifier un agent du terrain</title>
...
<div class="container">
    ...
    <div class="header">
        ...
        <h1>Modifier un agent du terrain</h1>
    ...
    <!-- FORM -->
    <form action="<%= request.getContextPath() %>/modifierAgent" method="post">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" id="telephone" name="telephone" value="<%= request.getAttribute("telephone") %>" required>
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="password" id="motDePasse" name="motDePasse" placeholder="Laisser vide si inchangé">
            </div>
        </div>
